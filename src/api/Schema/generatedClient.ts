...
import type { components, paths } from "./openApiType.d.ts"; // generated by openapi-typescript
...
export class Client<HT extends Record<string, string>> {
	 ...
	 */
	async getPetFindbystatus(params: {
	 ...
	 * Uploads an image.
	 */
	async postPetPetidUploadimage(
		params: { query: { additionalMetadata?: string }; path: { petId: number } },
		body: string,
	) {
